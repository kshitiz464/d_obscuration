...
# Updated `main.py` with simplified wind and drag logic

# main.py
"""
Simplified drone swarm simulation with minimal wind complexity and stable vertical behavior.
Removes vertical oscillation and keeps horizontal wind effects.
"""
import math
import random
from typing import List, Tuple, Optional
...
def run_simulation_scenario(
    ...
    nominal_spacing: float,
    hover_slowing_radius: float,
    vertical_hover_kp: float,
    vertical_hover_kd: float,
    ...
    flock = FlockingController(
        ...
        nominal_spacing=nominal_spacing,
        hover_slowing_radius=hover_slowing_radius,
        vertical_hover_kp=vertical_hover_kp,
        vertical_hover_kd=vertical_hover_kd
    )
